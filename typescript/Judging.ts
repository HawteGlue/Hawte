...
function teamLipSync() {
	...
	screen.createBold(`[${(bottomQueens as Array<Team>)[0].lipsyncQueen.getName()} and ${(bottomQueens as Array<Team>)[1].lipsyncQueen.getName()} will be performing]`);
...
function asLipSync() {
	...
	screen.createHeader("It's time...");
	screen.createBold("for you to perform in the Legacy Challenge! Good luck, and don't fuck it up.");
	lsSong();
	screen.createHorizontalLine();
